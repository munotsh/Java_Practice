...
public class CustomeDoublyLinkedList<T> {
	...
	public void pushNodeAtFront(T new_data) {
	...
	public void InsertBefore(Node next_node, T new_data) {
		if (next_node == null) {
	...
	public static void main(String[] args) {
		CustomeDoublyLinkedList<Integer> dll = new CustomeDoublyLinkedList<Integer>();
		dll.addAtEnd(6);
